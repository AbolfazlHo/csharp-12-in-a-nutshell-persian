...
اما هزینه این رشد و پیشرفت، این است که حالا مطالب بیشتری برای یاد گرفتن وجود دارد. البته ابزارهایی مثل IntelliSense مایکروسافت یا منابع آنلاین بسیار خوب‌اند و هنگام کدنویسی کمک بزرگی هستند، اما این ابزارها یک پیش‌فرض دارند: شما یک درک اولیه و نقشه ذهنی از مفاهیم اصلی دارید.
...
مثل هفت نسخه قبلی، کتاب C# 12 مبتنی بر مفاهیم و کاربردها تنظیم شده، که باعث می‌شود هم برای مطالعه پیوسته مناسب باشد و هم برای مرور و جستجوی موضوعی.
همچنین کتاب در حالی که تنها دانش اولیه برنامه‌نویسی را فرض می‌گیرد، وارد عمق مباحث می‌شود؛ بنابراین هم برای برنامه‌نویس‌های سطح متوسط قابل فهم است، و هم برای مخاطبان پیشرفته.
...
درست است که می‌توانید کدهای خود را در یک ویرایشگر ساده متنی بنویسید و با خط فرمان اجرا کنید،
